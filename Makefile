...
CFLAGS=			-g -Wall -O2
CPPFLAGS=		-Ihtslib
OBJS=			tigger-sv.o plp2sv.o cigar.o sv_qual.o mempool.o genotype.o bedidx.o asa147.o parse_bam_hdr.o
PROG=			tigger-sv
...
tigger-sv.o: plp2sv.h array.h mempool.h sv_qual.h genotype.h parse_bam_hdr.h
